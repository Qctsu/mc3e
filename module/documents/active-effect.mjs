...
export default class ActiveEffect5e extends ActiveEffect {
  ...
  apply(actor, change) {
    ...
    if ( change.key.startsWith("flags.mc3e.") ) change = this._prepareFlagChange(actor, change);
  ...
  _prepareFlagChange(actor, change) {
    ...
    const data = CONFIG.mc3e.characterFlags[key.replace("flags.mc3e.", "")];
    ...
    switch ( a.dataset.action ) {
      case "create":
        return owner.createEmbeddedDocuments("ActiveEffect", [{
          label: game.i18n.localize("mc3e.EffectNew"),
  ...
  static prepareActiveEffectCategories(effects) {
    ...
    const categories = {
      temporary: {
        type: "temporary",
        label: game.i18n.localize("mc3e.EffectTemporary"),
        effects: []
      },
      passive: {
        type: "passive",
        label: game.i18n.localize("mc3e.EffectPassive"),
        effects: []
      },
      inactive: {
        type: "inactive",
        label: game.i18n.localize("mc3e.EffectInactive"),
        effects: []
      },
      suppressed: {
        type: "suppressed",
        label: game.i18n.localize("mc3e.EffectUnavailable"),
        effects: [],
        info: [game.i18n.localize("mc3e.EffectUnavailableInfo")]
      }
    };
