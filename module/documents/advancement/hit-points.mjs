...
export default class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      order: 10,
      icon: "systems/mc3e/icons/svg/hit-points.svg",
      title: game.i18n.localize("mc3e.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("mc3e.AdvancementHitPointsHint"),
      multiLevel: true,
  ...
  /** @inheritdoc */
  get levels() {
    return Array.fromRange(CONFIG.mc3e.maxLevel + 1).slice(1);
  }
