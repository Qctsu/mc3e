...
export default class DamageRoll extends Roll {
  ...
  configureDamage() {
    ...
    if ( this.options.powerfulCritical && (flatBonus > 0) ) {
      ...
      this.terms.push(new NumericTerm({number: flatBonus}, {flavor: game.i18n.localize("mc3e.PowerfulCritical")}));
    }
  ...
  toMessage(messageData={}, options={}) {
    ...
    if ( this.isCritical ) {
      const label = game.i18n.localize("mc3e.CriticalHit");
      ...
      new Dialog({
        ...
        buttons: {
          critical: {
            ...
            label: game.i18n.localize("mc3e.CriticalHit"),
            callback: html => resolve(this._onDialogSubmit(html, true))
          },
          normal: {
            label: game.i18n.localize(allowCritical ? "mc3e.Normal" : "mc3e.Roll"),
