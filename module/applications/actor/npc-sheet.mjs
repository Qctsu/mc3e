...
export default class ActorSheet5eNPC extends ActorSheet5e {
  ...
  _prepareItems(context) {
    ...
    const features = {
      weapons: { label: game.i18n.localize("mc3e.AttackPl"), items: [], hasActions: true,
        dataset: {type: "weapon", "weapon-type": "natural"} },
      actions: { label: game.i18n.localize("mc3e.ActionPl"), items: [], hasActions: true,
        dataset: {type: "feat", "activation.type": "action"} },
      passive: { label: game.i18n.localize("mc3e.Features"), items: [], dataset: {type: "feat"} },
      equipment: { label: game.i18n.localize("mc3e.Inventory"), items: [], dataset: {type: "loot"}}
    };
  ...
  getArmorLabel() {
    ...
    const label = [];
    if ( ac.calc === "default" ) label.push(this.actor.armor?.name || game.i18n.localize("mc3e.ArmorClassUnarmored"));
    else label.push(game.i18n.localize(CONFIG.mc3e.armorClasses[ac.calc].label));
