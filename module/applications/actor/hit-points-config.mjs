...
export default class ActorHitPointsConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["mc3e", "actor-hit-points-config"],
      template: "systems/mc3e/templates/apps/hit-points-config.hbs",
      width: 320,
      height: "auto",
      sheetConfig: false
    });
  ...
  /** @inheritdoc */
  get title() {
    return `${game.i18n.localize("mc3e.HitPointsConfig")}: ${this.document.name}`;
  }
  ...
  async _onRollHPFormula(event) {
    ...
    try {
      ...
      ui.notifications.error(game.i18n.localize("mc3e.HPFormulaError"));
      throw error;
    }
  }
}
