...
export default class HitPointsFlow extends AdvancementFlow {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/mc3e/templates/advancement/hit-points-flow.hbs"
    });
  }
  ...
  _updateObject(event, formData) {
    ...
    throw new Advancement.ERROR(game.i18n.localize(`mc3e.AdvancementHitPoints${errorType}Error`));
  }
