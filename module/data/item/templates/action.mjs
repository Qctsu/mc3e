 ...
 * @property {string} actionType          Action type as defined in `mc3e.itemActionTypes`.
  ...
  static defineSchema() {
    return {
      ability: new foundry.data.fields.StringField({
        required: true, nullable: true, initial: null, label: "mc3e.AbilityModifier"
      }),
      actionType: new foundry.data.fields.StringField({
        required: true, nullable: true, initial: null, label: "mc3e.ItemActionType"
      }),
      attackBonus: new FormulaField({required: true, label: "mc3e.ItemAttackBonus"}),
      ...
      critical: new foundry.data.fields.SchemaField({
        threshold: new foundry.data.fields.NumberField({
          required: true, integer: true, initial: null, positive: true, label: "mc3e.ItemCritThreshold"
        }),
        damage: new FormulaField({required: true, label: "mc3e.ItemCritExtraDamage"})
      }),
      damage: new foundry.data.fields.SchemaField({
        ...
        versatile: new FormulaField({required: true, label: "mc3e.VersatileDamage"})
      }, {label: "mc3e.Damage"}),
      formula: new FormulaField({required: true, label: "mc3e.OtherFormula"}),
      save: new foundry.data.fields.SchemaField({
        ability: new foundry.data.fields.StringField({required: true, blank: true, label: "mc3e.Ability"}),
        dc: new foundry.data.fields.NumberField({
          required: true, min: 0, integer: true, label: "mc3e.AbbreviationDC"
        }),
        scaling: new foundry.data.fields.StringField({
          required: true, blank: false, initial: "spell", label: "mc3e.ScalingFormula"
        })
      }, {label: "mc3e.SavingThrow"})
    };
  }
