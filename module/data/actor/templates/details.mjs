...
export default class DetailsField {
  ...
  static get common() {
    return {
      biography: new foundry.data.fields.SchemaField({
        value: new foundry.data.fields.HTMLField({label: "mc3e.Biography"}),
        public: new foundry.data.fields.HTMLField({label: "mc3e.BiographyPublic"})
      }, {label: "mc3e.Biography"})
    };
  }
  ...
  static get creature() {
    return {
      alignment: new foundry.data.fields.StringField({required: true, label: "mc3e.Alignment"}),
      race: new foundry.data.fields.StringField({required: true, label: "mc3e.Race"})
    };
  }
}
