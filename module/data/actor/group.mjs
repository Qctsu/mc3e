...
/**
 * A data model and API layer which handles the schema and functionality of "group" type Actors in the mc3e system.
 ...
 * const g = new mc3e.documents.Actor5e({
 *  type: "group",
 *  name: "Test Group",
 *  system: {
  ...
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      description: new foundry.data.fields.SchemaField({
        full: new foundry.data.fields.HTMLField({label: "mc3e.Description"}),
        summary: new foundry.data.fields.HTMLField({label: "mc3e.DescriptionSummary"})
      }),
      members: new foundry.data.fields.SetField(
        ...
        {label: "mc3e.GroupMembers"}
      ),
      attributes: new foundry.data.fields.SchemaField({
        movement: new foundry.data.fields.SchemaField({
          land: new foundry.data.fields.NumberField({
            nullable: false, min: 0, step: 0.1, initial: 0, label: "mc3e.MovementLand"
          }),
          water: new foundry.data.fields.NumberField({
            nullable: false, min: 0, step: 0.1, initial: 0, label: "mc3e.MovementWater"
          }),
          air: new foundry.data.fields.NumberField({
            nullable: false, min: 0, step: 0.1, initial: 0, label: "mc3e.MovementAir"
          })
        })
