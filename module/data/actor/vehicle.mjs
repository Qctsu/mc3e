 ...
 *
 * @property {string} vehicleType                      Type of vehicle as defined in `mc3e.vehicleTypes`.
...
export default class VehicleData extends CommonTemplate {
  ...
  static defineSchema() {
    return this.mergeSchema(super.defineSchema(), {
      vehicleType: new foundry.data.fields.StringField({required: true, initial: "water", label: "mc3e.VehicleType"}),
      attributes: new foundry.data.fields.SchemaField({
        ...
        ac: new foundry.data.fields.SchemaField({
          ...
          motionless: new foundry.data.fields.StringField({required: true, label: "mc3e.ArmorClassMotionless"})
        }, {label: "mc3e.ArmorClass"}),
        hp: new foundry.data.fields.SchemaField({
          value: new foundry.data.fields.NumberField({
            nullable: true, integer: true, min: 0, initial: null, label: "mc3e.HitPointsCurrent"
          }),
          max: new foundry.data.fields.NumberField({
            nullable: true, integer: true, min: 0, initial: null, label: "mc3e.HitPointsMax"
          }),
          ...
          mt: new foundry.data.fields.NumberField({
            required: true, integer: true, min: 0, label: "mc3e.VehicleMishapThreshold"
          })
        }, {label: "mc3e.HitPoints"}),
        actions: new foundry.data.fields.SchemaField({
          stations: new foundry.data.fields.BooleanField({required: true, label: "mc3e.VehicleActionStations"}),
          value: new foundry.data.fields.NumberField({
            required: true, nullable: false, integer: true, initial: 0, min: 0, label: "mc3e.VehicleActionMax"
          }),
          thresholds: new foundry.data.fields.SchemaField({
            2: new foundry.data.fields.NumberField({
              required: true, integer: true, min: 0, label: "mc3e.VehicleActionThresholdsFull"
            }),
            1: new foundry.data.fields.NumberField({
              required: true, integer: true, min: 0, label: "mc3e.VehicleActionThresholdsMid"
            }),
            0: new foundry.data.fields.NumberField({
              required: true, integer: true, min: 0, label: "mc3e.VehicleActionThresholdsMin"
            })
          }, {label: "mc3e.VehicleActionThresholds"})
        }, {label: "mc3e.VehicleActions"}),
        capacity: new foundry.data.fields.SchemaField({
          creature: new foundry.data.fields.StringField({required: true, label: "mc3e.VehicleCreatureCapacity"}),
          cargo: new foundry.data.fields.NumberField({
            required: true, nullable: false, integer: true, initial: 0, min: 0, label: "mc3e.VehicleCargoCapacity"
          })
        }, {label: "mc3e.VehicleCargoCrew"})
      }, {label: "mc3e.Attributes"}),
      details: new foundry.data.fields.SchemaField(DetailsFields.common, {label: "mc3e.Details"}),
      traits: new foundry.data.fields.SchemaField({
        ...TraitsFields.common,
        size: new foundry.data.fields.StringField({required: true, initial: "lg", label: "mc3e.Size"}),
        di: TraitsFields.makeDamageTrait({label: "mc3e.DamImm"}, {initial: ["poison", "psychic"]}),
        ci: TraitsFields.makeSimpleTrait({label: "mc3e.ConImm"}, {initial: [
          "blinded", "charmed", "deafened", "frightened", "paralyzed",
          "petrified", "poisoned", "stunned", "unconscious"
        ]}),
        dimensions: new foundry.data.fields.StringField({required: true, label: "mc3e.Dimensions"})
      }, {label: "mc3e.Traits"}),
      cargo: new foundry.data.fields.SchemaField({
        crew: new foundry.data.fields.ArrayField(makePassengerData(), {label: "mc3e.VehicleCrew"}),
        passengers: new foundry.data.fields.ArrayField(makePassengerData(), {label: "mc3e.VehiclePassengers"})
      }, {label: "mc3e.VehicleCrewPassengers"})
    });
  }
...
function makePassengerData(schemaOptions={}) {
  return new foundry.data.fields.SchemaField({
    name: new foundry.data.fields.StringField({required: true, label: "mc3e.VehiclePassengerName"}),
    quantity: new foundry.data.fields.NumberField({
      required: true, nullable: false, integer: true, initial: 0, min: 0, label: "mc3e.VehiclePassengerQuantity"
    })
  }, schemaOptions);
}
