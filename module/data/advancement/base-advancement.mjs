  ...
  static defineSchema() {
    return {
      ...
      level: new foundry.data.fields.NumberField({
        integer: true, initial: this.metadata?.multiLevel ? undefined : 1, min: 0, label: "mc3e.Level"
      }),
      title: new foundry.data.fields.StringField({initial: undefined, label: "mc3e.AdvancementCustomTitle"}),
      icon: new foundry.data.fields.FilePathField({
        initial: undefined, categories: ["IMAGE"], label: "mc3e.AdvancementCustomIcon"
      }),
      classRestriction: new foundry.data.fields.StringField({
        initial: undefined, choices: ["primary", "secondary"], label: "mc3e.AdvancementClassRestriction"
      })
    };
  }
