  ...
  static defineSchema() {
    return {
      ...
      type: new foundry.data.fields.StringField({
        required: true, initial: "string", choices: TYPES, label: "mc3e.AdvancementScaleValueTypeLabel"
      }),
      distance: new foundry.data.fields.SchemaField({
        units: new foundry.data.fields.StringField({required: true, label: "mc3e.MovementUnits"})
      }),
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  static get metadata() {
    return {
      label: "mc3e.AdvancementScaleValueTypeString",
      hint: "mc3e.AdvancementScaleValueTypeHintString",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeNumber extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "mc3e.AdvancementScaleValueTypeNumber",
      hint: "mc3e.AdvancementScaleValueTypeHintNumber",
      isNumeric: true
    });
  }
...
export class ScaleValueTypeCR extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "mc3e.AdvancementScaleValueTypeCR",
      hint: "mc3e.AdvancementScaleValueTypeHintCR"
    });
  }
...
export class ScaleValueTypeDice extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "mc3e.AdvancementScaleValueTypeDice",
      hint: "mc3e.AdvancementScaleValueTypeHintDice"
    });
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "mc3e.AdvancementScaleValueTypeDistance",
      hint: "mc3e.AdvancementScaleValueTypeHintDistance"
    });
  }
  ...
  /** @inheritdoc */
  get display() {
    return `${this.value} ${CONFIG.mc3e.movementUnits[this.parent.configuration.distance?.units ?? "ft"]}`;
  }
}
